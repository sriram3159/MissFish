...
//     // const accessToken =
//     //   'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzU4NjgyNTkxLCJpYXQiOjE3NTgwNzc3OTEsImp0aSI6IjdkMWQ2ZTljYjJlNDQ5ODI5NjNmNDJmOWJkOWQ3NzI3IiwidXNlcl9pZCI6MTV9.lwoxNC-pblwHAi5ObAfK0DDKexr_-sSb_ED6X2ZnKg0';
...
import { useGlobalContext } from '../contexts/globalContext'; // Import GlobalContext
...
const OtpVerify = ({ navigation, route }) => {
  ...
  const {
    ...
    fetchCompleteOrder,
  } = useGlobalContext(); // Get functions from GlobalContext
  ...
  const handleNavigate = async () => {
    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        // ✅ Update token in GlobalContext
        await updateToken(data.tokens.access);
        ...
        // Navigation will be handled automatically by your stack navigator
        // based on the isLoggedIn state in AuthContext
      } else {
        setShowError(true);
